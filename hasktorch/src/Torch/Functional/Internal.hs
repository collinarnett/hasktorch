...
concatenate_ll
  ...
  -> Int -- ^ dim
  -> Tensor
concatenate_ll _tensors _dim = unsafePerformIO $ (cast2 ATen.concatenate_ll) _tensors _dim

concatenate_ln
  :: [Tensor] -- ^ tensors
  -> Dimname -- ^ dim
  -> Tensor
concatenate_ln _tensors _dim = unsafePerformIO $ (cast2 ATen.concatenate_ln) _tensors _dim
...
copy
  ...
  -> Bool -- ^ non_blocking
  -> Tensor
copy _self _src _non_blocking = unsafePerformIO $ (cast3 ATen.copy_ttb) _self _src _non_blocking
...
einsum
  ...
  -> [Int] -- ^ path
  -> Tensor
einsum _equation _tensors _path = unsafePerformIO $ (cast3 ATen.einsum_sll) _equation _tensors _path
...
unflatten_tll
  ...
  -> [Int] -- ^ sizes
  -> Tensor
unflatten_tll _self _dim _sizes = unsafePerformIO $ (cast3 ATen.unflatten_tll) _self _dim _sizes
...
unflatten_tnlN
  ...
  -> [Dimname] -- ^ names
  -> Tensor
unflatten_tnlN _self _dim _sizes _names = unsafePerformIO $ (cast4 ATen.unflatten_tnlN) _self _dim _sizes _names

fill_ts
  :: Tensor -- ^ self
  -> Float -- ^ value
  -> Tensor
fill_ts _self _value = unsafePerformIO $ (cast2 ATen.fill_ts) _self _value

fill_tt
  :: Tensor -- ^ self
  -> Tensor -- ^ value
  -> Tensor
fill_tt _self _value = unsafePerformIO $ (cast2 ATen.fill_tt) _self _value
...
miopen_convolution_relu
  ...
  -> Int -- ^ groups
  -> Tensor
miopen_convolution_relu _self _weight _bias _stride _padding _dilation _groups = unsafePerformIO $ (cast7 ATen.miopen_convolution_relu_tttllll) _self _weight _bias _stride _padding _dilation _groups
...
miopen_convolution_add_relu
  ...
  -> Int -- ^ groups
  -> Tensor
miopen_convolution_add_relu _self _weight _z _alpha _bias _stride _padding _dilation _groups = unsafePerformIO $ (cast9 ATen.miopen_convolution_add_relu_tttstllll) _self _weight _z _alpha _bias _stride _padding _dilation _groups
...
gelu
  ...
  -> String -- ^ approximate
  -> Tensor
gelu _self _approximate = unsafePerformIO $ (cast2 ATen.gelu_ts) _self _approximate
...
as_strided_scatter
  ...
  -> Int -- ^ storage_offset
  -> Tensor
as_strided_scatter _self _src _size _stride _storage_offset = unsafePerformIO $ (cast5 ATen.as_strided_scatter_ttlll) _self _src _size _stride _storage_offset
...
stft_tllltbbb
  ...
  -> Bool -- ^ return_complex
  -> Tensor
stft_tllltbbb _self _n_fft _hop_length _win_length _window _normalized _onesided _return_complex = unsafePerformIO $ (cast8 ATen.stft_tllltbbb) _self _n_fft _hop_length _win_length _window _normalized _onesided _return_complex
...
stft_tllltbsbbb
  ...
  -> Bool -- ^ return_complex
  -> Tensor
stft_tllltbsbbb _self _n_fft _hop_length _win_length _window _center _pad_mode _normalized _onesided _return_complex = unsafePerformIO $ (cast10 ATen.stft_tllltbsbbb) _self _n_fft _hop_length _win_length _window _center _pad_mode _normalized _onesided _return_complex
...
nansum
  ...
  -> DType -- ^ dtype
  -> Tensor
nansum _self _dim _keepdim _dtype = unsafePerformIO $ (cast4 ATen.nansum_tlbs) _self _dim _keepdim _dtype
...
frobenius_norm
  ...
  -> Bool -- ^ keepdim
  -> Tensor
frobenius_norm _self _dim _keepdim = unsafePerformIO $ (cast3 ATen.frobenius_norm_tlb) _self _dim _keepdim
...
mkldnn_reorder_conv2d_weight
  ...
  -> [Int] -- ^ input_size
  -> Tensor
mkldnn_reorder_conv2d_weight _self _padding _stride _dilation _groups _input_size = unsafePerformIO $ (cast6 ATen.mkldnn_reorder_conv2d_weight_tlllll) _self _padding _stride _dilation _groups _input_size
...
lift
  :: Tensor -- ^ self
  -> Tensor
lift _self = unsafePerformIO $ (cast1 ATen.lift_t) _self

lift_fresh
  :: Tensor -- ^ self
  -> Tensor
lift_fresh _self = unsafePerformIO $ (cast1 ATen.lift_fresh_t) _self

lift_fresh_copy
  :: Tensor -- ^ self
  -> Tensor
lift_fresh_copy _self = unsafePerformIO $ (cast1 ATen.lift_fresh_copy_t) _self
...
index_reduce
  ...
  -> Bool -- ^ include_self
  -> Tensor
index_reduce _self _dim _index _source _reduce _include_self = unsafePerformIO $ (cast6 ATen.index_reduce_tlttsb) _self _dim _index _source _reduce _include_self
...
scatter_reduce
  ...
  -> Bool -- ^ include_self
  -> Tensor
scatter_reduce _self _dim _index _src _reduce _include_self = unsafePerformIO $ (cast6 ATen.scatter_reduce_tlttsb) _self _dim _index _src _reduce _include_self
...
bitwise_and_st
  ...
  -> Tensor -- ^ other
  -> Tensor
bitwise_and_st _self _other = unsafePerformIO $ (cast2 ATen.bitwise_and_st) _self _other
...
bitwise_or_st
  ...
  -> Tensor -- ^ other
  -> Tensor
bitwise_or_st _self _other = unsafePerformIO $ (cast2 ATen.bitwise_or_st) _self _other
...
bitwise_xor_st
  ...
  -> Tensor -- ^ other
  -> Tensor
bitwise_xor_st _self _other = unsafePerformIO $ (cast2 ATen.bitwise_xor_st) _self _other
...
linalg_vander
  ...
  -> Int -- ^ N
  -> Tensor
linalg_vander _x _N = unsafePerformIO $ (cast2 ATen.linalg_vander_tl) _x _N
...
argsort_tblb
  ...
  -> Bool -- ^ descending
  -> Tensor
argsort_tblb _self _stable _dim _descending = unsafePerformIO $ (cast4 ATen.argsort_tblb) _self _stable _dim _descending
...
glu_jvp
  ...
  -> Int -- ^ dim
  -> Tensor
glu_jvp _glu _x _dx _dim = unsafePerformIO $ (cast4 ATen.glu_jvp_tttl) _glu _x _dx _dim
...
glu_backward_jvp
  ...
  -> Int -- ^ dim
  -> Tensor
glu_backward_jvp _grad_x _grad_glu _x _dgrad_glu _dx _dim = unsafePerformIO $ (cast6 ATen.glu_backward_jvp_tttttl) _grad_x _grad_glu _x _dgrad_glu _dx _dim
...
pad
  ...
  -> Double -- ^ value
  -> Tensor
pad _self _pad _mode _value = unsafePerformIO $ (cast4 ATen.pad_tlsd) _self _pad _mode _value
...
special_log_ndtr
  :: Tensor -- ^ self
  -> Tensor
special_log_ndtr _self = unsafePerformIO $ (cast1 ATen.special_log_ndtr_t) _self
...
linalg_lu
  ...
  -> Bool -- ^ pivot
  -> (Tensor,Tensor,Tensor)
linalg_lu _A _pivot = unsafePerformIO $ (cast2 ATen.linalg_lu_tb) _A _pivot
...
linalg_lu_solve
  ...
  -> Bool -- ^ adjoint
  -> Tensor
linalg_lu_solve _LU _pivots _B _left _adjoint = unsafePerformIO $ (cast5 ATen.linalg_lu_solve_tttbb) _LU _pivots _B _left _adjoint

linalg_det
  :: Tensor -- ^ A
  -> Tensor
linalg_det _A = unsafePerformIO $ (cast1 ATen.linalg_det_t) _A
...
linalg_ldl_factor_ex
  ...
  -> Bool -- ^ check_errors
  -> (Tensor,Tensor,Tensor)
linalg_ldl_factor_ex _self _hermitian _check_errors = unsafePerformIO $ (cast3 ATen.linalg_ldl_factor_ex_tbb) _self _hermitian _check_errors

linalg_ldl_factor
  :: Tensor -- ^ self
  -> Bool -- ^ hermitian
  -> (Tensor,Tensor)
linalg_ldl_factor _self _hermitian = unsafePerformIO $ (cast2 ATen.linalg_ldl_factor_tb) _self _hermitian
...
linalg_vecdot
  ...
  -> Int -- ^ dim
  -> Tensor
linalg_vecdot _x _y _dim = unsafePerformIO $ (cast3 ATen.linalg_vecdot_ttl) _x _y _dim
...
linalg_slogdet
  :: Tensor -- ^ A
  -> (Tensor,Tensor)
linalg_slogdet _A = unsafePerformIO $ (cast1 ATen.linalg_slogdet_t) _A
...
linalg_inv_ex
  ...
  -> Bool -- ^ check_errors
  -> (Tensor,Tensor)
linalg_inv_ex _A _check_errors = unsafePerformIO $ (cast2 ATen.linalg_inv_ex_tb) _A _check_errors

linalg_inv
  :: Tensor -- ^ A
  -> Tensor
linalg_inv _A = unsafePerformIO $ (cast1 ATen.linalg_inv_t) _A
...
linalg_svd
  ...
  -> String -- ^ driver
  -> (Tensor,Tensor,Tensor)
linalg_svd _A _full_matrices _driver = unsafePerformIO $ (cast3 ATen.linalg_svd_tbs) _A _full_matrices _driver

linalg_svdvals
  :: Tensor -- ^ A
  -> String -- ^ driver
  -> Tensor
linalg_svdvals _A _driver = unsafePerformIO $ (cast2 ATen.linalg_svdvals_ts) _A _driver
...
linalg_solve_ex
  ...
  -> Bool -- ^ check_errors
  -> (Tensor,Tensor)
linalg_solve_ex _A _B _left _check_errors = unsafePerformIO $ (cast4 ATen.linalg_solve_ex_ttbb) _A _B _left _check_errors
...
linalg_solve
  ...
  -> Bool -- ^ left
  -> Tensor
linalg_solve _A _B _left = unsafePerformIO $ (cast3 ATen.linalg_solve_ttb) _A _B _left
...
linalg_qr
  ...
  -> String -- ^ mode
  -> (Tensor,Tensor)
linalg_qr _A _mode = unsafePerformIO $ (cast2 ATen.linalg_qr_ts) _A _mode
...
nested_to_padded_tensor
  ...
  -> [Int] -- ^ output_size
  -> Tensor
nested_to_padded_tensor _self _padding _output_size = unsafePerformIO $ (cast3 ATen.nested_to_padded_tensor_tdl) _self _padding _output_size
...
segment_reduce
  ...
  -> Float -- ^ initial
  -> Tensor
segment_reduce _data _reduce _lengths _indices _offsets _axis _unsafe _initial = unsafePerformIO $ (cast8 ATen.segment_reduce_tstttlbs) _data _reduce _lengths _indices _offsets _axis _unsafe _initial
...
view_as_real_copy
  :: Tensor -- ^ self
  -> Tensor
view_as_real_copy _self = unsafePerformIO $ (cast1 ATen.view_as_real_copy_t) _self

view_as_complex_copy
  :: Tensor -- ^ self
  -> Tensor
view_as_complex_copy _self = unsafePerformIO $ (cast1 ATen.view_as_complex_copy_t) _self
...
as_strided_copy
  ...
  -> Int -- ^ storage_offset
  -> Tensor
as_strided_copy _self _size _stride _storage_offset = unsafePerformIO $ (cast4 ATen.as_strided_copy_tlll) _self _size _stride _storage_offset
...
diagonal_copy
  ...
  -> Int -- ^ dim2
  -> Tensor
diagonal_copy _self _offset _dim1 _dim2 = unsafePerformIO $ (cast4 ATen.diagonal_copy_tlll) _self _offset _dim1 _dim2
...
expand_copy
  ...
  -> Bool -- ^ implicit
  -> Tensor
expand_copy _self _size _implicit = unsafePerformIO $ (cast3 ATen.expand_copy_tlb) _self _size _implicit

permute_copy
  :: Tensor -- ^ self
  -> [Int] -- ^ dims
  -> Tensor
permute_copy _self _dims = unsafePerformIO $ (cast2 ATen.permute_copy_tl) _self _dims
...
select_copy
  ...
  -> Int -- ^ index
  -> Tensor
select_copy _self _dim _index = unsafePerformIO $ (cast3 ATen.select_copy_tll) _self _dim _index

detach_copy
  :: Tensor -- ^ self
  -> Tensor
detach_copy _self = unsafePerformIO $ (cast1 ATen.detach_copy_t) _self
...
slice_copy
  ...
  -> Int -- ^ step
  -> Tensor
slice_copy _self _dim _start _end _step = unsafePerformIO $ (cast5 ATen.slice_copy_tllll) _self _dim _start _end _step
...
split_copy
  ...
  -> Int -- ^ dim
  -> [Tensor]
split_copy _self _split_size _dim = unsafePerformIO $ (cast3 ATen.split_copy_tll) _self _split_size _dim
...
split_with_sizes_copy
  ...
  -> Int -- ^ dim
  -> [Tensor]
split_with_sizes_copy _self _split_sizes _dim = unsafePerformIO $ (cast3 ATen.split_with_sizes_copy_tll) _self _split_sizes _dim

squeeze_copy_t
  :: Tensor -- ^ self
  -> Tensor
squeeze_copy_t _self = unsafePerformIO $ (cast1 ATen.squeeze_copy_t) _self
...
t_copy
  :: Tensor -- ^ self
  -> Tensor
t_copy _self = unsafePerformIO $ (cast1 ATen.t_copy_t) _self
...
transpose_copy
  ...
  -> Int -- ^ dim1
  -> Tensor
transpose_copy _self _dim0 _dim1 = unsafePerformIO $ (cast3 ATen.transpose_copy_tll) _self _dim0 _dim1

unsqueeze_copy
  :: Tensor -- ^ self
  -> Int -- ^ dim
  -> Tensor
unsqueeze_copy _self _dim = unsafePerformIO $ (cast2 ATen.unsqueeze_copy_tl) _self _dim

indices_copy
  :: Tensor -- ^ self
  -> Tensor
indices_copy _self = unsafePerformIO $ (cast1 ATen.indices_copy_t) _self

values_copy
  :: Tensor -- ^ self
  -> Tensor
values_copy _self = unsafePerformIO $ (cast1 ATen.values_copy_t) _self

crow_indices_copy
  :: Tensor -- ^ self
  -> Tensor
crow_indices_copy _self = unsafePerformIO $ (cast1 ATen.crow_indices_copy_t) _self

col_indices_copy
  :: Tensor -- ^ self
  -> Tensor
col_indices_copy _self = unsafePerformIO $ (cast1 ATen.col_indices_copy_t) _self

ccol_indices_copy
  :: Tensor -- ^ self
  -> Tensor
ccol_indices_copy _self = unsafePerformIO $ (cast1 ATen.ccol_indices_copy_t) _self

row_indices_copy
  :: Tensor -- ^ self
  -> Tensor
row_indices_copy _self = unsafePerformIO $ (cast1 ATen.row_indices_copy_t) _self

unbind_copy
  :: Tensor -- ^ self
  -> Int -- ^ dim
  -> [Tensor]
unbind_copy _self _dim = unsafePerformIO $ (cast2 ATen.unbind_copy_tl) _self _dim

view_copy_tl
  :: Tensor -- ^ self
  -> [Int] -- ^ size
  -> Tensor
view_copy_tl _self _size = unsafePerformIO $ (cast2 ATen.view_copy_tl) _self _size

view_copy_ts
  :: Tensor -- ^ self
  -> DType -- ^ dtype
  -> Tensor
view_copy_ts _self _dtype = unsafePerformIO $ (cast2 ATen.view_copy_ts) _self _dtype
...
unfold_copy
  ...
  -> Int -- ^ step
  -> Tensor
unfold_copy _self _dimension _size _step = unsafePerformIO $ (cast4 ATen.unfold_copy_tlll) _self _dimension _size _step

alias_copy
  :: Tensor -- ^ self
  -> Tensor
alias_copy _self = unsafePerformIO $ (cast1 ATen.alias_copy_t) _self
...
special_airy_ai
  :: Tensor -- ^ x
  -> Tensor
special_airy_ai _x = unsafePerformIO $ (cast1 ATen.special_airy_ai_t) _x

special_bessel_j0
  :: Tensor -- ^ self
  -> Tensor
special_bessel_j0 _self = unsafePerformIO $ (cast1 ATen.special_bessel_j0_t) _self

special_bessel_j1
  :: Tensor -- ^ self
  -> Tensor
special_bessel_j1 _self = unsafePerformIO $ (cast1 ATen.special_bessel_j1_t) _self

special_bessel_y0
  :: Tensor -- ^ self
  -> Tensor
special_bessel_y0 _self = unsafePerformIO $ (cast1 ATen.special_bessel_y0_t) _self

special_bessel_y1
  :: Tensor -- ^ self
  -> Tensor
special_bessel_y1 _self = unsafePerformIO $ (cast1 ATen.special_bessel_y1_t) _self

special_chebyshev_polynomial_t_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_t_tt _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_t_tt) _x _n

special_chebyshev_polynomial_t_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_t_st _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_t_st) _x _n

special_chebyshev_polynomial_t_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_chebyshev_polynomial_t_ts _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_t_ts) _x _n

special_chebyshev_polynomial_u_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_u_tt _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_u_tt) _x _n

special_chebyshev_polynomial_u_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_u_st _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_u_st) _x _n

special_chebyshev_polynomial_u_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_chebyshev_polynomial_u_ts _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_u_ts) _x _n

special_chebyshev_polynomial_v_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_v_tt _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_v_tt) _x _n

special_chebyshev_polynomial_v_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_v_st _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_v_st) _x _n

special_chebyshev_polynomial_v_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_chebyshev_polynomial_v_ts _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_v_ts) _x _n

special_chebyshev_polynomial_w_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_w_tt _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_w_tt) _x _n

special_chebyshev_polynomial_w_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_chebyshev_polynomial_w_st _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_w_st) _x _n

special_chebyshev_polynomial_w_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_chebyshev_polynomial_w_ts _x _n = unsafePerformIO $ (cast2 ATen.special_chebyshev_polynomial_w_ts) _x _n

special_hermite_polynomial_h_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_hermite_polynomial_h_tt _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_h_tt) _x _n

special_hermite_polynomial_h_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_hermite_polynomial_h_st _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_h_st) _x _n

special_hermite_polynomial_h_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_hermite_polynomial_h_ts _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_h_ts) _x _n

special_hermite_polynomial_he_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_hermite_polynomial_he_tt _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_he_tt) _x _n

special_hermite_polynomial_he_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_hermite_polynomial_he_st _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_he_st) _x _n

special_hermite_polynomial_he_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_hermite_polynomial_he_ts _x _n = unsafePerformIO $ (cast2 ATen.special_hermite_polynomial_he_ts) _x _n

special_laguerre_polynomial_l_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_laguerre_polynomial_l_tt _x _n = unsafePerformIO $ (cast2 ATen.special_laguerre_polynomial_l_tt) _x _n

special_laguerre_polynomial_l_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_laguerre_polynomial_l_st _x _n = unsafePerformIO $ (cast2 ATen.special_laguerre_polynomial_l_st) _x _n

special_laguerre_polynomial_l_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_laguerre_polynomial_l_ts _x _n = unsafePerformIO $ (cast2 ATen.special_laguerre_polynomial_l_ts) _x _n

special_legendre_polynomial_p_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_legendre_polynomial_p_tt _x _n = unsafePerformIO $ (cast2 ATen.special_legendre_polynomial_p_tt) _x _n

special_legendre_polynomial_p_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_legendre_polynomial_p_st _x _n = unsafePerformIO $ (cast2 ATen.special_legendre_polynomial_p_st) _x _n

special_legendre_polynomial_p_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_legendre_polynomial_p_ts _x _n = unsafePerformIO $ (cast2 ATen.special_legendre_polynomial_p_ts) _x _n

special_modified_bessel_i0
  :: Tensor -- ^ self
  -> Tensor
special_modified_bessel_i0 _self = unsafePerformIO $ (cast1 ATen.special_modified_bessel_i0_t) _self

special_modified_bessel_i1
  :: Tensor -- ^ self
  -> Tensor
special_modified_bessel_i1 _self = unsafePerformIO $ (cast1 ATen.special_modified_bessel_i1_t) _self

special_modified_bessel_k0
  :: Tensor -- ^ self
  -> Tensor
special_modified_bessel_k0 _self = unsafePerformIO $ (cast1 ATen.special_modified_bessel_k0_t) _self

special_modified_bessel_k1
  :: Tensor -- ^ self
  -> Tensor
special_modified_bessel_k1 _self = unsafePerformIO $ (cast1 ATen.special_modified_bessel_k1_t) _self

special_scaled_modified_bessel_k0
  :: Tensor -- ^ x
  -> Tensor
special_scaled_modified_bessel_k0 _x = unsafePerformIO $ (cast1 ATen.special_scaled_modified_bessel_k0_t) _x

special_scaled_modified_bessel_k1
  :: Tensor -- ^ x
  -> Tensor
special_scaled_modified_bessel_k1 _x = unsafePerformIO $ (cast1 ATen.special_scaled_modified_bessel_k1_t) _x

special_shifted_chebyshev_polynomial_t_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_t_tt _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_t_tt) _x _n

special_shifted_chebyshev_polynomial_t_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_t_st _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_t_st) _x _n

special_shifted_chebyshev_polynomial_t_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_t_ts _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_t_ts) _x _n

special_shifted_chebyshev_polynomial_u_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_u_tt _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_u_tt) _x _n

special_shifted_chebyshev_polynomial_u_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_u_st _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_u_st) _x _n

special_shifted_chebyshev_polynomial_u_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_u_ts _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_u_ts) _x _n

special_shifted_chebyshev_polynomial_v_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_v_tt _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_v_tt) _x _n

special_shifted_chebyshev_polynomial_v_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_v_st _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_v_st) _x _n

special_shifted_chebyshev_polynomial_v_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_v_ts _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_v_ts) _x _n

special_shifted_chebyshev_polynomial_w_tt
  :: Tensor -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_w_tt _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_w_tt) _x _n

special_shifted_chebyshev_polynomial_w_st
  :: Float -- ^ x
  -> Tensor -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_w_st _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_w_st) _x _n

special_shifted_chebyshev_polynomial_w_ts
  :: Tensor -- ^ x
  -> Float -- ^ n
  -> Tensor
special_shifted_chebyshev_polynomial_w_ts _x _n = unsafePerformIO $ (cast2 ATen.special_shifted_chebyshev_polynomial_w_ts) _x _n
...
embedding_renorm
  ...
  -> Double -- ^ norm_type
  -> Tensor
embedding_renorm _self _indices _max_norm _norm_type = unsafePerformIO $ (cast4 ATen.embedding_renorm_ttdd) _self _indices _max_norm _norm_type
...
resize
  ...
  -> ATen.MemoryFormat -- ^ memory_format
  -> Tensor
resize _self _size _memory_format = unsafePerformIO $ (cast3 ATen.resize_tlM) _self _size _memory_format
...
resize_as
  ...
  -> ATen.MemoryFormat -- ^ memory_format
  -> Tensor
resize_as _self _the_template _memory_format = unsafePerformIO $ (cast3 ATen.resize_as_ttM) _self _the_template _memory_format

resize_as_sparse
  :: Tensor -- ^ self
  -> Tensor -- ^ the_template
  -> Tensor
resize_as_sparse _self _the_template = unsafePerformIO $ (cast2 ATen.resize_as_sparse_tt) _self _the_template

zero
  :: Tensor -- ^ self
  -> Tensor
zero _self = unsafePerformIO $ (cast1 ATen.zero_t) _self
...
sparse_resize
  ...
  -> Int -- ^ dense_dim
  -> Tensor
sparse_resize _self _size _sparse_dim _dense_dim = unsafePerformIO $ (cast4 ATen.sparse_resize_tlll) _self _size _sparse_dim _dense_dim
...
sparse_resize_and_clear
  ...
  -> Int -- ^ dense_dim
  -> Tensor
sparse_resize_and_clear _self _size _sparse_dim _dense_dim = unsafePerformIO $ (cast4 ATen.sparse_resize_and_clear_tlll) _self _size _sparse_dim _dense_dim
...
set_tt
  ...
  -> Tensor -- ^ source
  -> Tensor
set_tt _self _source = unsafePerformIO $ (cast2 ATen.set_tt) _self _source

set_t
  :: Tensor -- ^ self
  -> Tensor
set_t _self = unsafePerformIO $ (cast1 ATen.set_t) _self
